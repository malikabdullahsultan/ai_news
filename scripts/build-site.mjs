    ...
    <header class="site-header">
      <div class="nav-wrap">
        ...
        <nav class="main-nav" aria-label="Main navigation">
          ...
          ${navLink('architecture/', 'How it works', 'architecture')}
        </nav>
...
function architectureBody() {
  ...
  return architectureSummaryBody().replace('<section class="architecture-next page-container"', `${deepDive}<section class="architecture-next page-container"`);
}
...
await writeFile('architecture/index.html', siteShell({ title: 'How the site works', description: 'A friendly guide to the Daily AI Intelligence architecture.', body: architectureBody(), active: 'architecture' }));
